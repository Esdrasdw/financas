...
export const askFinancialAdvisor = async (
  ...
  dataContext +=
    "Observacoes: Valores em BRL (R$). TRANSACOES seguem {date, description, amount, type, category, recurrence, paymentMethod, status, cardId?}. INVESTIMENTOS seguem {name, amount, type, percentageOfCDI, startDate}.\n";
